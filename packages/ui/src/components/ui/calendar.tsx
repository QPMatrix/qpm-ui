  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        DayButton: ({ ...props }) => (
          // `locale` is spread conditionally rather than passed as
          // `locale={locale}`: under exactOptionalPropertyTypes an explicit
          // `undefined` is not the same as an absent prop, and react-day-picker
          // declares `locale?: Partial<DayPickerLocale>` without `| undefined`.
