    ...
    props: mergeProps<"button">(
      {
        ...
        // `outline-none` removes the default ring; the `focus-visible:`
        // pair REPLACES it. This element is a real, tabbable <button>
        // covering the whole attachment, so without a replacement a keyboard
        // user has no indication of where they are (WCAG 2.2 SC 2.4.7).
        className: cn(
          "absolute inset-0 z-10 rounded-lg outline-none focus-visible:ring-3 focus-visible:ring-ring/50",
          className,
        ),
      },
      props,
