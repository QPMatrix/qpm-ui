...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      /*
       * An icon-only control with no text node announces as "button" and
       * nothing else (WCAG 2.2 SC 4.1.2) — axe flagged exactly this in a real
       * browser. The default is English and sits BEFORE the prop spread, so a
       * localised app overrides it by passing `aria-label`.
       */
      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            // Same reason as ComboboxClear: icon-only, so it needs a name.
