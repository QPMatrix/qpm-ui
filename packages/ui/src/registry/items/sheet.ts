...
/** Base UI sheet primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 8 symbol(s). */
export const sheet: QpRegistryItem = {
  name: "sheet",
  type: "primitive",
  description:
    "Base UI sheet primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 8 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/sheet.tsx" }],
  ...
  tokenDependencies: ["fg-muted", "fg-primary", "surface-secondary"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: true,
