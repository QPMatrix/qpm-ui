...
/** Base UI message primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 6 symbol(s). */
export const message: QpRegistryItem = {
  name: "message",
  type: "primitive",
  description:
    "Base UI message primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 6 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/message.tsx" }],
  dependencies: [],
  ...
  tokenDependencies: ["fg-muted", "radius-full", "surface-tertiary"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: false,
