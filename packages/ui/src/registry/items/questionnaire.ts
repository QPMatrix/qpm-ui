...
/** Base UI questionnaire primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 15 symbol(s). */
export const questionnaire: QpRegistryItem = {
  name: "questionnaire",
  type: "primitive",
  description:
    "Base UI questionnaire primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 15 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/questionnaire.tsx" }],
