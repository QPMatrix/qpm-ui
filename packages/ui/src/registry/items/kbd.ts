...
/** Base UI kbd primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 2 symbol(s). */
export const kbd: QpRegistryItem = {
  name: "kbd",
  type: "primitive",
  description:
    "Base UI kbd primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 2 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/kbd.tsx" }],
  dependencies: [],
  ...
  tokenDependencies: ["bg-canvas", "fg-muted", "font-sans", "radius-sm", "surface-tertiary"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: false,
