...
/** Base UI direction primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 2 symbol(s). */
export const direction: QpRegistryItem = {
  name: "direction",
  type: "primitive",
  description:
    "Base UI direction primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 2 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/direction.tsx" }],
