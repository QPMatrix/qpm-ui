...
/** Base UI popover primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 6 symbol(s). */
export const popover: QpRegistryItem = {
  name: "popover",
  type: "primitive",
  description:
    "Base UI popover primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 6 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/popover.tsx" }],
  ...
  tokenDependencies: ["fg-muted", "fg-primary", "radius-lg", "surface-secondary"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: true,
