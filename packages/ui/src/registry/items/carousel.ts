...
/** Base UI carousel primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 7 symbol(s). */
export const carousel: QpRegistryItem = {
  name: "carousel",
  type: "primitive",
  description:
    "Base UI carousel primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 7 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/carousel.tsx" }],
