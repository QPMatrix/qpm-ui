...
/** Base UI slider primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 1 symbol(s). */
export const slider: QpRegistryItem = {
  name: "slider",
  type: "primitive",
  description:
    "Base UI slider primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 1 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/slider.tsx" }],
  ...
  tokenDependencies: ["border-focus", "brand-strong", "radius-full", "surface-tertiary"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: true,
