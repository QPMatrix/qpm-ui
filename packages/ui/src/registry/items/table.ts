...
/** Base UI table primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 8 symbol(s). */
export const table: QpRegistryItem = {
  name: "table",
  type: "primitive",
  description:
    "Base UI table primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 8 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/table.tsx" }],
  dependencies: [],
  ...
  tokenDependencies: ["fg-muted", "fg-primary", "surface-tertiary"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: true,
