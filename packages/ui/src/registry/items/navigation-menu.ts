...
/** Base UI navigation menu primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 9 symbol(s). */
export const navigationMenu: QpRegistryItem = {
  name: "navigation-menu",
  type: "primitive",
  description:
    "Base UI navigation menu primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 9 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/navigation-menu.tsx" }],
