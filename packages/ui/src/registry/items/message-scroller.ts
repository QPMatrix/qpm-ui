...
/** Base UI message scroller primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 9 symbol(s). */
export const messageScroller: QpRegistryItem = {
  name: "message-scroller",
  type: "primitive",
  description:
    "Base UI message scroller primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 9 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/message-scroller.tsx" }],
  ...
  tokenDependencies: ["bg-canvas", "border-default", "fg-primary", "surface-tertiary"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: true,
