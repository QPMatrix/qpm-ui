...
/** Base UI scroll area primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 2 symbol(s). */
export const scrollArea: QpRegistryItem = {
  name: "scroll-area",
  type: "primitive",
  description:
    "Base UI scroll area primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 2 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/scroll-area.tsx" }],
  ...
  tokenDependencies: ["border-default", "border-focus", "radius-full"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: false,
