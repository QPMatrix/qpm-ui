...
/** Base UI attachment primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 9 symbol(s). */
export const attachment: QpRegistryItem = {
  name: "attachment",
  type: "primitive",
  description:
    "Base UI attachment primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 9 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/attachment.tsx" }],
