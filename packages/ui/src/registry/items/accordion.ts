...
/** Base UI accordion primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 4 symbol(s). */
export const accordion: QpRegistryItem = {
  name: "accordion",
  type: "primitive",
  description:
    "Base UI accordion primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 4 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/accordion.tsx" }],
  ...
  tokenDependencies: ["border-focus", "fg-muted", "fg-primary", "radius-lg"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: true,
