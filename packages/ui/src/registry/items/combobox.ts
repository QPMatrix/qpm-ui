...
/** Base UI combobox primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 16 symbol(s). */
export const combobox: QpRegistryItem = {
  name: "combobox",
  type: "primitive",
  description:
    "Base UI combobox primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 16 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/combobox.tsx" }],
  dependencies: ["@base-ui/react", "lucide-react"],
  registryDependencies: ["button", "cn", "input-group"],
  aliases: {
    ui: "@/components/ui",
    utils: "@/lib/utils",
  },
