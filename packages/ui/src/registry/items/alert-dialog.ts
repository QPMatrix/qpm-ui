...
/** Base UI alert dialog primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 12 symbol(s). */
export const alertDialog: QpRegistryItem = {
  name: "alert-dialog",
  type: "primitive",
  description:
    "Base UI alert dialog primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 12 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/alert-dialog.tsx" }],
