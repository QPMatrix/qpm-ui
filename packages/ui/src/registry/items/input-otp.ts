...
/** Base UI input otp primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 4 symbol(s). */
export const inputOtp: QpRegistryItem = {
  name: "input-otp",
  type: "primitive",
  description:
    "Base UI input otp primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 4 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/input-otp.tsx" }],
