...
/** Base UI collapsible primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 3 symbol(s). */
export const collapsible: QpRegistryItem = {
  name: "collapsible",
  type: "primitive",
  description:
    "Base UI collapsible primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 3 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/collapsible.tsx" }],
