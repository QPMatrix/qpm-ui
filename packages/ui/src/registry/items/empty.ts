...
/** Base UI empty primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 6 symbol(s). */
export const empty: QpRegistryItem = {
  name: "empty",
  type: "primitive",
  description:
    "Base UI empty primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 6 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/empty.tsx" }],
