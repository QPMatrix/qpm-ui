...
/** Base UI bubble primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 4 symbol(s). */
export const bubble: QpRegistryItem = {
  name: "bubble",
  type: "primitive",
  description:
    "Base UI bubble primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 4 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/bubble.tsx" }],
