...
/** Base UI marker primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 4 symbol(s). */
export const marker: QpRegistryItem = {
  name: "marker",
  type: "primitive",
  description:
    "Base UI marker primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 4 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/marker.tsx" }],
  ...
  tokenDependencies: ["border-default", "fg-muted", "fg-primary"],
  accessibility: {
    status: "partial",
    wcagLevel: "2.2-AA",
    interactive: false,
