...
/** Base UI context menu primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 15 symbol(s). */
export const contextMenu: QpRegistryItem = {
  name: "context-menu",
  type: "primitive",
  description:
    "Base UI context menu primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 15 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/context-menu.tsx" }],
