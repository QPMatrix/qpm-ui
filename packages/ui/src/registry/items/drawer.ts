...
/** Base UI drawer primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 11 symbol(s). */
export const drawer: QpRegistryItem = {
  name: "drawer",
  type: "primitive",
  description:
    "Base UI drawer primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 11 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/drawer.tsx" }],
