...
/** Base UI spinner primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 1 symbol(s). */
export const spinner: QpRegistryItem = {
  name: "spinner",
  type: "primitive",
  description:
    "Base UI spinner primitive, installed from shadcn/ui and bound to @qpmatrix/tokens. Exports 1 symbol(s).",
  version: "0.1.0",
  files: [{ path: "packages/ui/src/components/ui/spinner.tsx" }],
